...
with DAG(
    ...
    create_app_image = BashOperator(
        ...
        cwd=project_root,
        # bash_command = "docker build -t ml-classifier:latest . "
        bash_command="""
        docker build -t ${DOCKER_HUB_USERNAME}/ml-classifier:latest .
        echo ${DOCKER_HUB_TOKEN} | docker login -u ${DOCKER_HUB_USERNAME} --password-stdin
        docker push ${DOCKER_HUB_USERNAME}/ml-classifier:latest
        """
    )
